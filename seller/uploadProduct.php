<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
		...
		$sql = "INSERT INTO fproduct (fid, product, pcat, pinfo, price,stock)
			   VALUES ('$fid', '$productName', '$productType', '$productInfo', '$productPrice','$stock')";
	...
	<body>
		...
		<!-- One -->
			...
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<form method="POST" action="uploadProduct.php" enctype="multipart/form-data">
						...
						<br>
				<center>
				<h1 style="color:white">Product image</h1>	
					  ...
					  <div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto" >
							  <select name="type" id="type" required style="background-color:white;color: black;">
								  ...
								  <option value="hardwood" style="color: black;">hardwood</option>
								  <option value="softwood" style="color: black;">softwood</option>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					  <input type="number" name="stock" id="stock" value="" placeholder="stock" style="background-color:white;color: black;" />
				</div>
