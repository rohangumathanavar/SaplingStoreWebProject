		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
				...
				<?php
				    ...
				    if(isset($_GET['type']) AND $_GET['type'] == "hardwood")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'hardwood'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "softwood")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'softwood'";
					}
