<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
       // echo"$pid";  
        ...
        // $sql = "SELECT pstock from fproduct where pid='$pid'";
        // //echo"$sql";
        // $result = mysqli_query($conn, $sql);
        // $User = $result->fetch_assoc();
        // $a=$User['pstock'];
        // $a=$a-$order;
        // $sql="UPDATE fproduct set pstock='$a' where pid='$pid' ";
        // $result = mysqli_query($conn, $sql);
...
<body>
    ...
    <section id="main" class="wrapper" >
        ...
        <div class="container">
            <center>
                <form method="post" action="BuyNow1.php?pid=<?= $pid; ?>&order1=<?= $order; ?>" style="border: 1px solid black; padding: 15px;">
                    <center>
