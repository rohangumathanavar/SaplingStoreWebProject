						...
						<div class="container">
							<div class="row">
								...
								<!-- <div class="3u 12u$(xsmall)">
            							<a href="deleteproduct.php?pid=<?php echo $row['pid'] ;?>" class="btn btn-danger" style="text-decoration: none;">Delete Product</a>
            						</div> -->
								<div class="col-12 col-sm-6">
									...
									<p style="font: 30px Times new roman;">Stock Left : <?= $row['stock'].''; ?></p>
